...
func (m *TreeWalkerImpMock) Walk(root string, fn fs.WalkDirFunc) error {
...
func (bldr *TreeWalkerImpWalkBuilder) ExpectArgsAre(root string, fn fs.WalkDirFunc) *TreeWalkerImpWalkCall {
