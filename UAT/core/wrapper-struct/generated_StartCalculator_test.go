...
// Completes verifies the method completes without panicking.
func (h *StartCalculatorWrapperProcessCallHandle) Completes() {
	h.T.Helper()
	h.WaitForResponse()
...
// PanicEquals verifies the method panics with the expected value.
func (h *StartCalculatorWrapperProcessCallHandle) PanicEquals(expected any) {
	h.T.Helper()
	h.WaitForResponse()
...
// PanicShould verifies the method panics with a value matching the given matcher.
func (h *StartCalculatorWrapperProcessCallHandle) PanicShould(matcher any) {
	h.T.Helper()
	h.WaitForResponse()
...
// ReturnsEqual verifies the method returned the expected values.
func (h *StartCalculatorWrapperProcessCallHandle) ReturnsEqual(v0 string, v1 error) {
	h.T.Helper()
	h.WaitForResponse()
...
// ReturnsShould verifies the return values match the given matchers.
func (h *StartCalculatorWrapperProcessCallHandle) ReturnsShould(v0 any, v1 any) {
	h.T.Helper()
	h.WaitForResponse()
