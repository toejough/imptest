...
func (h *StartConditionalFuncCallHandle) PanicEquals(expected any) {
	h.T.Helper()
	h.WaitForResponse()
...
func (h *StartConditionalFuncCallHandle) PanicShould(matcher any) {
	h.T.Helper()
	h.WaitForResponse()
...
func (h *StartConditionalFuncCallHandle) ReturnsEqual(v0 int) {
	h.T.Helper()
	h.WaitForResponse()
...
func (h *StartConditionalFuncCallHandle) ReturnsShould(v0 any) {
	h.T.Helper()
	h.WaitForResponse()
...
func (e *StartConditionalFuncCallHandleEventually) PanicEquals(value any) {
	e.ensureStarted().ExpectPanic(value)
}

// ReturnsEqual registers an async expectation for return values.
func (e *StartConditionalFuncCallHandleEventually) ReturnsEqual(values ...any) {
