...
func (e *WrapSlowAddCallHandleEventually) ExpectReturn(values ...any) {
	e.ensureStarted().ExpectReturn(values...)
}

// ExpectPanic registers an async expectation for a panic value.
func (e *WrapSlowAddCallHandleEventually) ExpectPanic(value any) {
	e.ensureStarted().ExpectPanic(value)
}

// Start executes the wrapped function in a goroutine.
func (w *WrapSlowAddWrapperHandle) Start(a, b int, delay time.Duration) *WrapSlowAddCallHandle {
...
func (h *WrapSlowAddCallHandle) ExpectReturn(v0 int) {
	h.T.Helper()
	h.WaitForResponse()
...
func (h *WrapSlowAddCallHandle) ExpectReturnMatch(v0 any) {
	h.T.Helper()
	h.WaitForResponse()
...
func (h *WrapSlowAddCallHandle) ExpectPanic(expected any) {
	h.T.Helper()
	h.WaitForResponse()
...
func (h *WrapSlowAddCallHandle) ExpectPanicMatch(matcher any) {
	h.T.Helper()
	h.WaitForResponse()
