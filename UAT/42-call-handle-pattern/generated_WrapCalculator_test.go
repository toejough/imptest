...
// WrapCalculatorWrapper wraps an implementation of callhandle.Calculator to intercept method calls.
type WrapCalculatorWrapper struct {
	impl         callhandle.Calculator
...
// WrapCalculator creates a new wrapper for the given callhandle.Calculator implementation.
func WrapCalculator(t *testing.T, impl callhandle.Calculator) *WrapCalculatorWrapper {
