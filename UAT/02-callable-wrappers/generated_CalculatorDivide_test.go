...
type CalculatorDivide struct {
	*_imptest.CallableController[CalculatorDivideReturn]
...
func NewCalculatorDivide(t _testing.TB, callable func(numerator, denominator int) (int, bool)) *CalculatorDivide {
	return &CalculatorDivide{
		CallableController: _imptest.NewCallableController[CalculatorDivideReturn](t),
		callable:           callable,
	}
}
