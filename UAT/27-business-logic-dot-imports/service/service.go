...
import (
	...
	. "github.com/toejough/imptest/UAT/27-business-logic-dot-imports/storage" //nolint:revive,depguard,staticcheck // Dot import intentional - demonstrates business logic dot import pattern
)
