...
//
//nolint:revive // path parameter unused in example implementation
func (c ConfigManager) Load(path string) struct {
	...
	return struct {
		...
		Host: "localhost",
		Port: 8080, //nolint:mnd // example port value
		TLS:  false,
	}
}
...
func GetDefaults() struct {
	...
	return struct {
		...
		MaxRetries: 3,  //nolint:mnd // default retry count
		Timeout:    30, //nolint:mnd // default timeout seconds
	}
}
