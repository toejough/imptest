...
type CalculatorMultiply struct {
	*imptest.CallableController[CalculatorMultiplyReturn]
...
func NewCalculatorMultiply(t testing.TB, callable func(value int) int) *CalculatorMultiply {
	return &CalculatorMultiply{
		CallableController: imptest.NewCallableController[CalculatorMultiplyReturn](t),
		callable:           callable,
	}
}
