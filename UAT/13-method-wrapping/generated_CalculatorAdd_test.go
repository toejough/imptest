...
type CalculatorAdd struct {
	*imptest.CallableController[CalculatorAddReturn]
...
func NewCalculatorAdd(t testing.TB, callable func(a, b int) int) *CalculatorAdd {
	return &CalculatorAdd{
		CallableController: imptest.NewCallableController[CalculatorAddReturn](t),
		callable:           callable,
	}
}
