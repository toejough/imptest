...
type CalculatorProcessValue struct {
	*imptest.CallableController[CalculatorProcessValueReturn]
...
func NewCalculatorProcessValue(t testing.TB, callable func(value int) int) *CalculatorProcessValue {
	return &CalculatorProcessValue{
		CallableController: imptest.NewCallableController[CalculatorProcessValueReturn](t),
		callable:           callable,
	}
}
