...
// TestStringifyStructType_NilFields verifies proper handling of edge cases
// with nil field lists.
func TestStringifyStructType_NilFields(t *testing.T) {
	t.Parallel()
