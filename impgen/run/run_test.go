...
func TestCheckCachedHash(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
		...
		{
			name:         "file exists but no hash",
			filename:     "nohash.go",
			expectedHash: "abc123",
			fileContent:  "// Code generated by impgen. DO NOT EDIT.\n\npackage foo\n",
			fileExists:   true,
			want:         false,
		},
		{
			...
			fileContent:  "// Code generated by impgen. DO NOT EDIT.\n// impgen:hash:abc123def456\n\npackage foo\n",
			fileExists:   true,
			want:         true,
		},
		{
			name:         "file exists with different hash",
			filename:     "different.go",
			expectedHash: "abc123",
			fileContent:  "// Code generated by impgen. DO NOT EDIT.\n// impgen:hash:xyz789\n\npackage foo\n",
			fileExists:   true,
			want:         false,
	...
	for _, testCase := range tests {
		t.Run(testCase.name, func(t *testing.T) {
			...
			if testCase.fileExists {
				reader.files[testCase.filename] = []byte(testCase.fileContent)
			}

			got := checkCachedHash(testCase.filename, testCase.expectedHash, reader)
			if got != testCase.want {
				t.Errorf("checkCachedHash() = %v, want %v", got, testCase.want)
			}
		})
	}
}
