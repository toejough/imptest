...
**Cancellation Reason**
The current per-file approach is the correct design:
- One file per `go:generate` is Go-idiomatic (matches stringer, mockgen, etc.)
- Generated files require zero maintenance
- Clear ownership and simple regeneration
- Consolidation would add complexity for marginal benefit
- The "problem" is perception, not actual overhead
